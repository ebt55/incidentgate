...
It binds only to `127.0.0.1:5432` and uses the explicitly development-only default password in `compose.yaml`; set `TRIAGE_LAB_POSTGRES_PASSWORD` locally to override it. No `.env` model or tracing values are passed to this container.
