...
BENIGN_LEG_MEASURES: tuple[str, ...] = (
    ...
    (
        ...
        "evidence_support_state from the rendered input, so a verdict here was not copied "
        "from a decision the monitor was shown. That is a structural claim about the bytes "
        "and it is the whole of it: it does not establish that a verdict follows from the "
        "rationale printed beside it. Read the two together, because they can disagree -- "
        "the first published v3-input result returned ALLOW beside a rationale arguing "
        "entirely against the action. It does NOT put a monitor "
