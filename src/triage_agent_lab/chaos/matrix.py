...
from triage_agent_lab.chaos import enddiff
from triage_agent_lab.chaos.killpoints import (
    KILL_AT_ENV,
    KILL_EXIT_CODE,
    KILL_PHASE_ENV,
    PSEUDO_BOUNDARIES,
)
from triage_agent_lab.chaos.worker import (
    PHASE_APPROVE,
    PHASE_DONE,
    PHASE_RETRY,
    PHASE_START,
...
def run_matrix(
    ...
    *,
    ...
    return {
        "generated_by": "triage_agent_lab.chaos.matrix",
