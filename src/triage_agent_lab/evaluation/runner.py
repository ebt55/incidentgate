...
from triage_agent_lab.integration.adapters import (
...
class CheckpointBEvaluationRunner:
    ...
    def _safeguards(mode: EvaluationMode, *, action_attempted: bool) -> SafeguardsRecord:
        from triage_agent_lab.contracts import StageDisposition
    ...
    def _synthetic_s1(
        ...
        from triage_agent_lab.contracts import CanonicalAction
        from triage_agent_lab.lab.errors import ApprovalDenied
    ...
    def run(self, *, trial: int = 0) -> CheckpointBRawEnvelope:
        ...
        return CheckpointBRawEnvelope(
            ...
            reproduction_command=f"python -m triage_agent_lab.evaluation.runner checkpoint-b --mock-evaluation --git-revision {self.git_revision} --output <planned-output>",
